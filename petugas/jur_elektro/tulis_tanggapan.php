                                        ...
                                        <form action="simpan_tanggapan.php" method="POST">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-user" id="judul" name="no" readonly value="<?php echo $data['no']; ?>">
                                                </div>
                                                <label for="">Judul Laporan</label>
                                                <input type="text" class="form-control form-control-user" id="judul" name="judul" readonly value="<?php echo $data['judul']; ?>">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-user" id="judul" name="id" readonly value="<?php echo $_SESSION['id_user']; ?>">
                                            </div>

                                            <br>
                                            <div style="justify-content: center; align-items: center;" class="text-center">
                                                <input type="submit" value="Kirim" name="" class="btn-primary" style="border-radius: 6px; align-center">
                                                <input type="reset" value="Reset" name="" class="btn-danger" style="border-radius: 6px;">
                                            </div>
                                        <?php } ?>
                                        </form>
                                </div>
