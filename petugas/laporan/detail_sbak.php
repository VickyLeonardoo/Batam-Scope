                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Cari Judul Laporan" aria-label="Search" aria-describedby="basic-addon2">
                                     ...
                                     <div class="form-group">
                                        ...
                                        readonly value="<?php echo $data['unit'];?>">
                                            ...
                                            <div style="justify-content: center; align-items: center;" class="text-center">
                                                <input type="submit" value="Selesai" name="" class="btn-success" style="border-radius: 6px; align-center">
                                            </div>
                                        <?php } ?>
                                        </form>
                                </div>
